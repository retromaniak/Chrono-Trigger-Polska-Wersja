...
OSTRZEŻENIE: PRZED UŻYCIEM SYSTEMU NINTENDO LUB GAME PAKU NALEŻY UWAŻNIE PRZECZYTAĆ ZAŁĄCZONĄ BROSZURĘ Z INFORMACJAMI UŻYTKOWNIKA I ŚRODKAMI OSTROŻNOŚCI
...
`Strona 12`
# Pierwsze Kroki
Upewnij się, że zasilanie Control Decka jest wyłączone. Włóż Game Pak do gniazda w górnej części Decka, a następnie włącz zasilanie.
## Ekran Demo
Ekran demonstracyjny pokazuje sceny z gry. Aby je pominąć, wystarczy nacisnąć przycisk A.
## Nowa Gra
Aby rozpocząć nową grę, wybierz opcję "Nowa gra" na ekranie otwierającym menu za pomocą panelu sterowania i naciśnij przycisk Start.
## Kontynuacja Gry
Zamiast wybierać opcję "Nowa gra", można wybrać zapisaną grę i rozpocząć od miejsca, w którym ostatnio zapisano grę.

`Strona 13`
# Tryby Walki - Aktywny i Czasowy
W bitwie używane są dwa różne tryby: Aktywny i Czasowy. Możesz również wybrać jeden z nich w Konfiguracji. (strona 23)
## Aktywny
Aktywny polecamy profesjonalistom. Po wybraniu tego trybu potwory nie będą czekać, aż zdecydujesz się na plan ataku.
## Czasowy
Czasowy jest dla początkujących. Będziesz miał więcej czasu na wybranie metody ataku.

Jest to bardziej emocjonujący tryb walki, ale musisz szybko zdecydować, co zrobić.

`Strona 14`
# Wprowadzanie Imion
Postępuj zgodnie z poniższymi instrukcjami, aby wprowadzić nazwę na początku gry lub zmienić ją później.
## Zmiana Imion
Aby wprowadzić lub zmienić nazwę, najpierw wybierz literę za pomocą kursora i naciśnij przycisk A. Powtarzaj tę czynność do momentu wpisania imienia, a następnie naciśnij przycisk Start. Jeśli wprowadzisz błędną literę, naciśnij przycisk B, aby usunąć literę i kontynuować.

Wybrana nazwa będzie wyświetlana przez całą grę.

`Strona 15`
# Zapisywanie Postępu
Można zapisać do trzech różnych gier. Istnieją również trzy miejsca, z których można rozpocząć zapisaną grę. Po wznowieniu zapisanej gry można ją rozpocząć od dowolnego z tych trzech zapisów.
## Ekran Mapy
Na ekranie mapy można w dowolnym momencie otworzyć ekran zapisu, aby zapisać grę.
## Punkty Zapisu
W całej grze znajdują się punkty zapisu. Przejdź do ekranu zapisu w menu głównym (strona 18), stając na punkcie zapisu i naciskając przycisk X.
## Koniec Czasu
Gdy dotrzesz do "Końca czasu", zapisz grę w punkcie zapisu.

`Strona 16`
# Ekran Główny: Pola Dialogowe
Pola dialogowe to miejsca, w którym rozgrywa się większość akcji. Zobaczysz te dymki, gdy znajdziesz się wewnątrz domów, lochów itp.
## Wewnątrz Domów
Odbędziesz wiele rozmów z ludźmi w domach. Naciśnij A, aby z nimi porozmawiać. Odkryjesz również różne przedmioty.
### Skrzynia Skarbów
Naciśnij A, aby otworzyć skrzynię skarbów i odzyskać znajdujące się w niej przedmioty.
### Drzwi
Naciśnij A, aby otworzyć drzwi przed sobą.
### Jedzenie
Naciśnij A, aby podnieść znalezione jedzenie. Uzupełni to PŻ i MP.
### Schody
Możesz iść w górę lub w dół po schodach. Użyj krzyżaka, aby określić kierunek.
## Lochy
Lochy są pełne potworów i pułapek. Jeśli natkniesz się na potwory lub ich dotkniesz, automatycznie rozpoczniesz walkę (strona 28).

`Strona 17`
# Ekran Główny: Ekran Mapy
Ekran mapy wyświetla świat, w którym się znajdujesz. Gdy zbliżysz się do budynku lub obszaru geograficznego, wyświetli się jego nazwa. Aby wejść do budynku lub obszaru, naciśnij przycisk A.
## Świat
W widoku świata możesz przemieszczać się między budynkami, jaskiniami i innymi lokacjami. Gdy znajdziesz się w pobliżu obszaru, do którego chcesz wejść, naciśnij A.
### Budynki
Tylko niektóre kolorowe budynki są dostępne.
### Góry
Góry również są pełne potworów. Zachowaj ostrożność.
### Lasy
Lasy są pełne potworów. Szukaj też ukrytych skrzyń.
### Jaskinie
W jaskiniach można znaleźć zarówno przydatne przedmioty, jak i niebezpieczne potwory.
## Mapa Świata
Na ekranie poziomym naciśnij przycisk Select, aby uzyskać dostęp do mapy świata. Kropka na mapie wskazuje twoją lokalizację.

`Strona 18`
# Ekran Podrzędny: Status
Naciśnij przycisk X, aby przejść do ekranu menu głównego. Pojawi się menu z sześcioma ikonami. Użyj krzyżaka, aby przesunąć kursor, a przycisku A, aby dokonać wyboru.
|   |                |   |                    |
|---|----------------|---|--------------------|
| A | Status Postaci | D |       Konfig.      |
| B |   Przedmioty   | E | Kolejność Postaci  |
| C |      Tech      | F |      Zapis Gry     |
## A - Status Postaci
...
Kiedy jesteś na tym ekranie, umiejętności techniczne podświetlone na żółto to te, których możesz użyć.
...
Aby przenieść postać, przesuń kursor na nią i naciśnij przycisk A. Następnie przesuń kursor w miejsce, w którym chcesz ją umieścić i naciśnij przycisk A.
...
Kiedy znajdziesz Luccę, ona i jej ojciec próbują zademonstrować swoje urządzenie teleportacyjne. Nikt nie będzie próbował. Jeśli chcesz spróbować, stań na lewej platformie. Pamiętaj, aby najpierw zapisać.
...
Oficjalny Poradnik do gry Chrono Trigger dostępny jest od 1 października 1995 roku.
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ3OTAyOTU0LC04NDIxMDkzODAsLTIxMz
